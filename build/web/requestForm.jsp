...
<html>
    ...
    <body>
            ...
            <div class="col-sm-12 requestTable">
               ...
               <table>
                    ...
                    <tr id="<%= r.getReq_id()%>"> 
                        ...
                        <td><%= r.getAddress() %></td>
                        <td><%= r.getReq_type() %></td>
                        <%if(r.getStatus().equals("Completed")){ System.out.println("completed Request");%>
       ...
       <div class="container-fluid myfooter" id="downfooter" id="" style="height: 15vw;">
            ...
            <div class="row okrow">
                ...
                <div class="col-sm-4"id="contact" style="text-align: center;padding-top:1vw;">
                  Contact us
                  <p> 16-9-406/A/80, Ground Floor Vijay Nagar,<br>New Market,Bhopal 435612</p>
                  <p> Phone: 9589774573</p>
                  <p> Email: harshitaj192@gmail.com</p>
                </div>
            </div>    
        </div>
    </body>
